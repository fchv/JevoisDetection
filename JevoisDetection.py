...
class JevoisDetection:
    ## Constructor
    def __init__(self):

        self.__blur_type = 0

        #The constants below are found using GRIP
...
############## The code below is generated by GRIP ##############
...
############## End of code generated by GRIP ##############


        
        # These are functions calculate the position and size of the detected object
